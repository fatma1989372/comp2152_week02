...
print("You rolled a", weaponRoll, "Your weapon is:", chosenWeapon)

combatStrength = combatStrength + weaponRoll
print("After using your weapon, your combat strength is now:", combatStrength)

heroWeapon = weapons[weaponRoll - 1]
print("The hero's weapon is:", heroWeapon)
